...
- `/rare <target> <port> <time>` - Initiate a DDoS attack on the specified target.
...
- `/genkey <userId> <duration>` - Add a user with a specified approval duration.
...
For any queries or support, contact [@RARExxOWNER]([https://t.me/RARExxOWNER]) on Telegram.
---
